...
para partículas sin carga).\cite{biela}
%%%%%%%%%%%%%%%%%%%%%%%%%%%
%   marco teorico
%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newpage
...
La librería Numpy utiliza el algoritmo Mersenne Twistter\cite{tan} (MT19937) para la generación de números pseudoaleatorios. Este método particular tiene la cualidad de tener una periodicidad bastante grande en la generación de números: $2^19937-1$\cite{mako}.
...
Charles M.(1993), {Leibniz y los dos problemas de M{\'e}r{\'e}}, Revista de la Sociedad Espa{\~n}ola de Historia de las Ciencias y de las T{\'e}cnicas {\bf 16} 241

\bibitem[{Bielajew (2001)}] {biela}
Bielajew A. (2001), Some random thoughts on Monte Carlo electron and photon transport

\bibitem[{Gentle (2006)}] {gent}
Gentle J. (2006), Random number generation and Monte Carlo methods

\bibitem[{Krauth, Werner (2006)}] {krauth}
Krauth, Werner (2006), Statistical mechanics: algorithms and computations

\bibitem[{Makoto (1998)}]{mako}
Matsumoto, Makoto and Nishimura, Takuji (1998), Mersenne twister: a 623-dimensionally equidistributed uniform pseudo-random number generator

\bibitem[{Tanguy (2019)}]{tan}
pagina web (2019), How Does Your Computer Generate Random Numbers?
